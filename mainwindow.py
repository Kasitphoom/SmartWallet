...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, -109, 381, 860))
...
"border-radius: 15px;")
        ...
        self.limitscrollAreaWidgetContents.setGeometry(QRect(0, 0, 381, 90))
...
"")
        ...
        self.frame_12.setMinimumSize(QSize(27, 24))
        ...
        self.featuresframe.setMinimumSize(QSize(0, 175))
...
"color: white;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"0 THB", None))
