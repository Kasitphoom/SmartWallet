...
"height: 10px;")
        ...
        self.limitscrollAreaWidgetContents.setGeometry(QRect(-250, 0, 720, 81))
...
"")
        ...
        self.housinglimitframe = QFrame(self.limitscrollAreaWidgetContents)
        self.housinglimitframe.setObjectName(u"housinglimitframe")
        sizePolicy2.setHeightForWidth(self.housinglimitframe.sizePolicy().hasHeightForWidth())
        self.housinglimitframe.setSizePolicy(sizePolicy2)
        self.housinglimitframe.setMinimumSize(QSize(79, 81))
        self.housinglimitframe.setLayoutDirection(Qt.LeftToRight)
        self.housinglimitframe.setStyleSheet(u"background-color: rgb(238, 238, 238);\n"
"border-radius: 5px;\n"
"")
        self.housinglimitframe.setFrameShape(QFrame.StyledPanel)
        self.housinglimitframe.setFrameShadow(QFrame.Raised)
        self.verticalLayout_17 = QVBoxLayout(self.housinglimitframe)
        self.verticalLayout_17.setObjectName(u"verticalLayout_17")
        self.verticalLayout_17.setContentsMargins(-1, 9, -1, 9)
        self.housinglimiticon = QLabel(self.housinglimitframe)
        self.housinglimiticon.setObjectName(u"housinglimiticon")
        self.housinglimiticon.setFont(font6)
        self.housinglimiticon.setStyleSheet(u"color: rgb(137, 137, 137);")
        self.housinglimiticon.setAlignment(Qt.AlignCenter)

        self.verticalLayout_17.addWidget(self.housinglimiticon)

        self.housinglimitlabel = QLabel(self.housinglimitframe)
        self.housinglimitlabel.setObjectName(u"housinglimitlabel")
        self.housinglimitlabel.setFont(font7)
        self.housinglimitlabel.setAlignment(Qt.AlignCenter)

        self.verticalLayout_17.addWidget(self.housinglimitlabel)

        self.limitcurrency_7 = QLabel(self.housinglimitframe)
        ...
        self.horizontalLayout_7.addWidget(self.housinglimitframe)
...
"from every type of expense ", None))
        ...
        self.housinglimiticon.setText(QCoreApplication.translate("MainWindow", u"building", None))
        self.housinglimitlabel.setText(QCoreApplication.translate("MainWindow", u"0.00", None))
